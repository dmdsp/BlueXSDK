...
@interface ToponNativeViewController ()<UITableViewDelegate,UITableViewDataSource,ATNativeADDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NSDictionary *dict = @{};
      [[ATAdManager sharedManager] loadADWithPlacementID:@"n1ge27qaotsgom" extra:dict delegate:self];
}
